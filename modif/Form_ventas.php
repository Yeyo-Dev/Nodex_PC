...
$id = $_GET['id'];
$sql = "SELECT * FROM ventas WHERE venta_folio='$id'";
...
?> 
           ...
           <h1>Formulario Ventas</h1>
               ...
               <input class="controls" required value="<?php echo $rowCunt['producto_id']?>" type="text" name="producto_id" id="producto_id" placeholder="Inserte ID de producto">
