...
try{
    ...
    if($tabla == "almacen"){
        ...
        $query = $query ."empleado_id='$id', empleado_nombre='$empleado_nombre',";
        if($empleado_fotografia != ''){
            $query = $query ." empleado_fotografia='$empleado_fotografia',";
        }

        $query = $query ." empleado_apellidoP='$empleado_apellidoP', empleado_apellidoM='$empleado_apellidoM', empleado_fechaNacimiento='$empleado_fechaNacimiento', empleado_direccion='$empleado_direccion', empleado_email='$empleado_email', empleado_telFijo='$empleado_telFijo', empleado_telCel='$empleado_telCel', empleado_cargo='$empleado_cargo', empleado_usuario='$empleado_usuario' WHERE empleado_id='$id'";
        ...
        $query = $query ."proveedor_id='$id', proveedor_nombre='$proveedor_nombre',";
        if($proveedor_fotografia != ''){
            $query = $query ." proveedor_fotografia='$proveedor_fotografia',";
        }
 
        $query = $query . " proveedor_apellidoP='$proveedor_apellidoP', proveedor_apellidoM='$proveedor_apellidoM', proveedor_tipoProducto='$proveedor_tipoProducto', proveedor_email='$proveedor_email' WHERE proveedor_id='$id';";
